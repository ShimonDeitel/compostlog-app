...
struct ContentView: View {
    ...
    @State private var editingEntry: AdditionEntry?
...
struct EntryFormView: View {
    ...
    private func save() {
        switch mode {
        case .add:
            let entry = AdditionEntry(date: date, material: material, notes: notes)
            store.add(entry)
